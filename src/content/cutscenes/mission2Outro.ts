...
export class Mission2Outro extends Cutscene {
    ...
    async runScript() {
        ...
        await this.speak(this.sprite, `That was the last bull!`);
        await this.speak(this.sprite, `Now it should be safe for the refugees to resettle.`);
        await this.speak(this.sprite, `Let's go back to the guild, Ruthven's waiting for us.`);
        ...
        // Make sure the portal to mission 2 is open during this scene, we will close it
        // at the end.
