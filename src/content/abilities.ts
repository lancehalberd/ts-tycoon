...
'specializationIndex': {name: '-----Specialization-----'},
    ...
    'minionToughness': {name: 'Ally Toughness', 'icon': jobIcons.ranger, 'bonuses': {'%minion:maxHealth': .5, '%minion:armor': .3}},
    'minionDamage': {name: 'Ally Damage', 'icon': jobIcons.ranger, 'bonuses': {'%minion:damage': .3, '%minion:accuracy': .3}},
    'minionFerocity': {name: 'Ally Ferocity', 'icon': jobIcons.ranger, 'bonuses': {'%minion:attackSpeed': .5, '%minion:critChance': .3}},
...
'tier1Index': {name: '------Tier 1------'},
    'jugglerIndex': {name: '---Juggler---'},
        'juggler': {name: 'Juggling', 'icon': jobIcons.juggler, 'bonuses': {'$throwing:attack:chaining': 'Projectiles ricochet between targets until they miss.'}},
        'sap': {name: 'Sap', 'icon': jobIcons.juggler, 'bonuses': {'+slowOnHit': .1, '+healthGainOnHit': 1},
            onMissEffect: {
        ...
        'acrobatics': {name: 'Acrobatics', 'icon': jobIcons.dancer, 'bonuses': {'+evasion': 2, '-dodge:cooldown': 2, '*dodge:distance': 2}},
    ...
    'blackbeltIndex': {name: '---Blackbelt---'},
        'blackbelt': {name: 'Martial Arts', 'icon': jobIcons.blackbelt,
            'bonuses': {'*unarmed:damage': 3, '*unarmed:attackSpeed': 1.5, '+unarmed:critChance': .15, '*unarmed:critDamage': 2, '*unarmed:critAccuracy': 2}},
        'vitality': {name: 'Vitality', 'icon': jobIcons.blackbelt, 'bonuses': {'+healthRegen': ['{strength}', '/', 10], '+strength': 5}},
        'counterAttack': {name: 'Counter Attack', 'icon': jobIcons.blackbelt, 'bonuses': {'+strength': 5}, 'reaction': skills.counterAttack},
        'counterPower': {name: 'Improved Counter', 'icon': jobIcons.blackbelt, 'bonuses': {'+strength': 5, '+counterAttack:attackPower': .5, '*counterAttack:accuracy': 1.5}},
        'counterChance': {name: 'Heightened Reflexes', 'icon': jobIcons.blackbelt, 'bonuses': {'+dexterity': 5, '+counterAttack:chance': .1}},
        'dragonPunch': {name: 'Dragon Punch', 'icon': jobIcons.blackbelt, 'action': skills.dragonPunch},
...
'tier4Index': {name: '------Tier 4------'},
    'assassinIndex': {name: '---Assassin---'},
        ...
        'cull': {name: 'Cull', 'bonuses': {'+strength': 10, '+cull': .1}, 'icon': jobIcons.assassin},
        'cripple': {name: 'Cripple', 'bonuses': {'+strength': 10, '+dexterity': 10}, 'icon': jobIcons.assassin,
...
testAbilities = [abilities.pet, abilities.attackSong, abilities.defenseSong, abilities.heroSong];
