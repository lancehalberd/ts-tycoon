...
function angleBetweenVectors(vector1: Point, vector2: Point): number {
...
function isPointInArray(point: Point, points: Point[]): boolean {
...
function toShapeDefinition(key: ShapeType, array: ShapeArrayDefinition): ShapeDefinition {
    ...
    return { key, lengths, angles, color, angle, area };
}
