...
import { mainCanvas, mainContext, query, queryAll, tagElement, toggleElements } from 'app/dom';
import { MAP_LEFT, MAP_TOP, MAP_HEIGHT, WORLD_RADIUS } from 'app/gameConstants';
...
export function handleEditMapKeyDown(keyCode: number): boolean {
    const { editingMap } = editingMapState;
