...
import { createCanvas, jewelsCanvas } from 'app/dom';
import { drawBoardBackground } from 'app/drawBoard';
import { equipItemProper, exportItem, importItem } from 'app/inventory';
import {
    displayJewelShapeScale, makeJewelProper, makeFixedJewel,
    originalJewelScale, updateAdjacentJewels,
} from 'app/jewels';
import { exportState, getState, importState } from 'app/state';
import { makeShape, Polygon, shapeDefinitions } from 'app/utils/polygon';

import {
    Applicant, Board, Character, EquipmentAffix, Hero, Jewel, JewelComponents,
    SavedActor, SavedAffix, SavedApplicant, SavedBoard, SavedCharacter,
    SavedFixedJewel, SavedJewel, SavedShape
} from 'app/types';
...
export function exportCharacter(character: Character | Applicant): SavedCharacter {
    return {
        ...
        endlessAreaPortal: character.endlessAreaPortal,
        endlessExperience: character.endlessExperience,
        endlessLevel: character.endlessLevel,
    };
}
...
export function importCharacter(characterData: SavedCharacter) {
    ...
    const character: Character = {
        ...
        endlessAreasVisited: {},
        endlessAreaPortal: characterData.endlessAreaPortal,
        endlessExperience: characterData.endlessExperience || 0,
        endlessLevel: characterData.endlessLevel || 1,
    };
