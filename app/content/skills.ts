...
import { Actor, ArrayFrame } from 'app/types';
...
export const skills: {[key: string]: ActionData} = {
    ...
    'charge': attackAction('charge', {'icon': jobIcons.warrior, 'tags': ['movement']}, {'+range': 15, '*damage': 2, '+cooldown': 10, '+speedBonus': 3, '+stun': .5,
                                        ...
                                        'Charge enemies, damaging and stunning them briefly on impact.'),
    'recklessCharge': attackAction('charge',
        {'icon': jobIcons.warrior, 'tags': ['movement', 'targetsDirection']},
        {'+range': 30, '*damage': 3, '+cooldown': 10, '+speedBonus': 3, '+stun': 2.5,
         '+prepTime': 1, '$alwaysHits': 'Never misses'},
        'Recklessly charge enemies, damaging and stunning them on impact. Stuns the user if they hit an obstacle.'),
