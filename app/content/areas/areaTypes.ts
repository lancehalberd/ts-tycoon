...
import {
    ...
    BACKGROUND_HEIGHT, MIN_Z, RANGE_UNIT,
} from 'app/gameConstants';
import { createAnimation, frame, drawFrame } from 'app/utils/animations';
import SRandom from 'app/utils/SRandom';

import {
    Ability, Area, AreaLayer,
    AreaType, Exit, LootGenerator, FrameAnimation,
} from 'app/types';
...
//    frame(0, 0, 39, 148, {x: 16, y: 92, w: 23, h: 35}), {cols: 2}).frames;
